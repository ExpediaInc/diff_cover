...
# all lines for which we have coverage,
# all lines for which had violations
# all lines in diff which had violations
class DiffViolations:
    ...
    def __init__(self, violations, measured_lines, diff_lines):
        ...
        if measured_lines is None:
            ...
            # Update to use line number for everything
            self.measured_lines = {
                measuredInfo
...
class BaseReportGenerator:
    ...
    # Total number of instructions in diff
    def total_num_lines(self):
        ...
        """
        arr =  [
            ins.total_instructions
            for summary in self._diff_violations().values()
                for ins in summary.measured_lines
        ]
        print(arr)
        ...
        print("Total instructions from _diff_violations: ", tot)
        return tot

    # Total number of violation in diff
    def total_num_violations(self):
        ...
        """
        arr =  [
            ins.missed_instructions
            for summary in self._diff_violations().values()
                for ins in summary.violations
        ]
        print(arr)
        tot = sum(
            [
        ...
        print("Total missed instructions from _diff_violations: ", tot)
        return tot

    # Total percentage of diff
